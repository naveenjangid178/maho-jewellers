...
const ShoppingCard = ({ name, index, image, grossWeight, netWeight, sku }) => {
    return (
        <Tilt
            ...
            tiltMaxAngleY={10}
            key={index}
            className="text-center flex flex-col gap-2 md:min-w-65 min-w-full max-w-72 shadow-xs shadow-gray-500 bg-transparent backdrop-blur-2xl rounded">
            <img src={image} alt={name} className="w-full h-62 object-center mb-2" />
