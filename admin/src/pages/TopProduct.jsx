...
import AddTopProduct from '../components/AddTopProduct';
...
const TopProduct = () => {
    ...
    const removeFromFeatured = async (productId) => {
        try {
            const response = await axios.delete(`${import.meta.env.VITE_API_URL}/top-product/${productId}`);
    ...
    return (
        <div className="p-4 space-y-6">
            ...
            {addProductToCatalogue && <AddTopProduct addProductToCatalogue={addProductToCatalogue} setAddProductToCatalogue={setAddProductToCatalogue} />}
        </div>
    )
}
