...
import AddFeaturedProduct from '../components/AddFeaturedProduct';
...
const Featured = () => {
    ...
    const removeFromFeatured = async (productId) => {
        try {
            const response = await axios.delete(`${import.meta.env.VITE_API_URL}/featured/${productId}`);
    ...
    return (
        <div className="p-4 space-y-6">
            ...
            {addProductToCatalogue && <AddFeaturedProduct addProductToCatalogue={addProductToCatalogue} setAddProductToCatalogue={setAddProductToCatalogue} />}
        </div>
    )
}
